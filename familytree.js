...
(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.prototype.addPartnerAndParentNodes = function (e, t, i, r, a) {
    ...
    if (FamilyTree.isNEU(t))
      ...
      if (FamilyTree.isNEU(o.mid) || FamilyTree.isNEU(o.fid)) {
        FamilyTree.isNEU(o.mid)
          ? (o.mid = i.id)
          : FamilyTree.isNEU(o.mid) || (o.fid = i.id),
          l.push(o);
        var s = null;
        Array.isArray(i.pids) &&
          (1 != i.pids.length &&
        ...
        if (!1 !== this._fireUpdate_addUpdateRemove(d, a)) {
          ...
          s
            ? (m = s.id)
            : FamilyTree.isNEU(o.pid)
            ? FamilyTree.isNEU(o.mid)
              ? FamilyTree.isNEU(o.fid) || (m = o.fid)
              : (m = o.mid)
            : (m = o.pid),
  ...
  (FamilyTree.editUI.prototype.show = function (e, t, i) {
    ...
    for (
      var n = this.obj.element.querySelectorAll("[bft-input-btn]"), l = 0;
      l < n.length;
      l++
    ) {
          ...
          if (c) {
            ...
            if (g.left || g.right || g.up || g.down) {
              ...
              if (
                ...
                !1 === FamilyTree.events.publish("drag", [s, k, t]) && b(),
                  (e._dragEventFired = !0);
              u.setAttribute("transform", "matrix(" + m.toString() + ")");
            }
          }
  ...
  (FamilyTree.searchUI.prototype._serverSearch = function (e) {
      ...
      a = `<table border="0" cellspacing="0" cellpadding="0">\n                    <tbody>\n                        ${(function () {
        for (
          ...
          if (r) {
            ...
            "function" == typeof r
              ? (l = r(t.obj, t.obj.getNode(n.id), o))
              : o[r] && (l = o[r]);
          }
          var s = "",
            d = "";
    ...
    for (
      var n = this.obj.element.querySelectorAll("[data-search-item-id]"), l = 0;
      l < n.length;
      l++
    )
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    for (var s = i.nodes, d = [], c = 0; c < s.length; c++) {
      ...
      FamilyTree.isNEU(p.ppid) || (f.ppid = p.ppid),
        FamilyTree.isNEU(p.stpid) || (f.stpid = p.stpid),
        null != i.orderBy &&
          (f.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)),
        (e[p.id] = f),
        d.push(p.id);
    }
    null != i.orderBy &&
    ...
    for (c = 0; c < d.length; c++) {
      ...
      if ((g || (f.stpid = null), b || (f.pid = null), g)) {
        ...
        b
          ? (y && ((f.collapsed = y.collapsed), (f.min = y.min)),
  ...
  (FamilyTree.manager._createNodes = function (e) {
        ...
        if (m) {
          ...
          if (!f) {
            if (!FamilyTree.isNEU(m.pid))
              (H = (T = o[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
                T.childrenIds.splice(H, 1);
            s.push(m);
          }
        }
      }
    ...
    for (c = 0; c < C.length; c++) {
      ...
      for (F = 0; F < g.children.length; F++) {
        (R = g.children[F]).isAssistant
          ...
          : -1 == R.tags.indexOf("partner") || E % 2
          ? -1 != R.tags.indexOf("partner") && E % 2
            ? ((R.isPartner = 2), (R.children = []), A.push(R.id), E++)
            : R.parentPartner
            ? (M[R.parentPartner.id] || (M[R.parentPartner.id] = []),
              M[R.parentPartner.id].push(R.id))
            : I.push(R.id)
          : ((R.isPartner = 1), (R.children = []), N.push(R.id), E++);
      }
      g.children = [];
      var P = [];
      ...
      (g.partnerSeparation =
        Math.max(B.length, O.length) * t.partnerChildrenSplitSeparation +
    ...
    for (c = 0; c < k.length; c++) {
      if (
        (re = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout ==
          FamilyTree.normal ||
        !S[g.pid]
      )
        for (F = 0; F < g.subLevels; F++) {
          ...
          if ((FamilyTree.manager._initDinamicNode(j, g.lcn), (T = g.parent)))
            (H = T.children.indexOf(g)) > -1 &&
              (T.children.splice(H, 1), T.children.splice(H, 0, j)),
              j.children.push(g),
              (j.parent = T),
              (g.parent = j),
              (o[j.id] = j);
      ...
      for (F = q.length - 1; F >= 0; F--)
        if (F % 2 && F != q.length - 1) {
          var W = new FamilyTree.node(
            T.id + "_split_assitant_" + V,
            null,
            [],
            "split"
          );
          FamilyTree.manager._initDinamicNode(W, T.lcn, !0),
            (o[W.id] = W),
            q.splice(F, 0, W.id),
            V++;
        } else F % 2 && q.splice(F, 0, j.id);
    ...
    for (var ee in i) {
      if (
        (re = i[ee]).layout == FamilyTree.mixed ||
        re.layout == FamilyTree.tree ||
        re.layout == FamilyTree.treeRightOffset ||
        re.layout == FamilyTree.treeLeftOffset
      ) {
        Q = !0;
        break;
      }
    ...
    if (Q || te) {
      ...
      for (var $ in S) {
        var re;
        if (
          (re = i[(T = o[$]).lcn ? T.lcn : "base"]).layout ==
            FamilyTree.mixed ||
          re.layout == FamilyTree.tree ||
          re.layout == FamilyTree.treeRightOffset ||
          re.layout == FamilyTree.treeLeftOffset ||
          ...
          if (
            ...
            j = new FamilyTree.node(T.id + "_split_0", T.id, [], "split");
            FamilyTree.manager._initDinamicNode(j, T.lcn),
              (o[j.id] = j),
            ...
            for (c = ie.childrenIds.length - 1; c >= 0; c--) {
              ...
              if (
                ...
                var oe = new FamilyTree.node(
                  R.id + "_mirror",
                  null,
                  [],
                  "mirror"
                );
                FamilyTree.manager._initDinamicNode(oe, R.lcn),
                  (oe.layout = FamilyTree.tree),
                  (o[oe.id] = oe),
                  le.splice(0, 0, oe.id);
              }
            ...
            for (V = 1, F = le.length - 1; F >= 0; F--)
              if (F % 2 && F != le.length - 1) {
                ...
                FamilyTree.manager._initDinamicNode(W, T.lcn),
                  (W.layout = FamilyTree.tree),
                  (o[W.id] = W),
                  le.splice(F, 0, W.id),
                  V++;
              } else F % 2 && le.splice(F, 0, j.id);
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    ...
    for (p = 0; p < d.length; p++) {
      ...
      if (b) {
        var T = [];
        FamilyTree.manager._iterateSetRootIds(b.id, b.id, m, c, e, T),
          l.push(T);
      }
    }
        ...
        if (
          ...
          for (var T = 0; T < i[g.id].length; T++) {
            ...
            v &&
              ...
              FamilyTree.manager._iterateFT(i[g.id][T], t, i, r, a, n, l, o, s);
          }
  ...
  (FamilyTree.templates.mother.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;"  stroke-width="1" stroke="#F57C00" rx="5" ry="5"></rect><text style="font-size: 18px;" fill="#F57C00" x="240" y="30" text-anchor="end">+ Mẹ</text>' +
  ...
  (FamilyTree.templates.father.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#039BE5;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#039BE5" x="240" y="30" text-anchor="end">+ Cha</text>' +
  ...
  (FamilyTree.templates.son.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#039BE5;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#039BE5" x="240" y="30" text-anchor="end">+ Con trai</text>' +
  ...
  (FamilyTree.templates.daughter.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#F57C00;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#F57C00" x="240" y="30" text-anchor="end">+ Con gái</text>' +
  ...
  (FamilyTree.templates.husband.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#039BE5;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#039BE5" x="240" y="30" text-anchor="end">+ Chồng</text>' +
  ...
  (FamilyTree.templates.wife.node =
    '<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#F57C00;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#F57C00" x="240" y="30" text-anchor="end">+ Vợ</text>' +
  ...
  (FamilyTree.ui = {
    ...
    node: function (e, t, i, r, a, n, l, o, s, d) {
      ...
      var b = FamilyTree._getPosition(i, e, a, n),
        T = "node";
      Array.isArray(e.tags) && e.tags.length && (T += " " + e.tags.join(" ")),
        e.layout && (T += " tree-layout");
      var v = "";
      e.lcn && (v = 'lcn="' + e.lcn + '"');
      ...
      for (u = 0; u < e.children.length; u++) {
        ...
        if (-1 != T.indexOf("{rounded}"))
          if (
            ...
            Math.abs(b.xa - b.xd) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(b.xa - b.xc) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(b.xa - b.xb) <= FamilyTree.LINK_ROUNDED_CORNERS
          )
            T = T.replace(
              "{rounded}",
            ...
            Math.abs(b.ya - b.yd) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(b.ya - b.yc) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(b.ya - b.yb) <= FamilyTree.LINK_ROUNDED_CORNERS
          )
            T = T.replace(
              "{rounded}",
  ...
  FamilyTree.events.on("redraw", function (e, t) {
    if (e.config.miniMap) {
      ...
      r.clearRect(0, 0, i.width, i.height),
        r.translate(
          -e.response.boundary.minX * l + o,
          -e.response.boundary.minY * l + s
        ),
        r.scale(l, l);
      var d = 0,
        c = [];
    ...
    for (var s = {}, d = 0; d < e.length; d++)
      for (var c = e[d], m = 0; m < i.length; m++) {
        ...
        if (!FamilyTree.isNEU(c[p])) {
          var h = c[p];
          if (
            null != (t = FamilyTree._search.searchAndComputeScore(o, h, p, n))
          ) {
            var f = c.id;
            if (s[f]) {
  ...
  (FamilyTree.state._put = function (e, t, i, r, a, n, l) {
    if (l) {
      ...
      if (l.writeToUrlParams) {
        ...
        d.has(o.paramScale)
          ? d.set(o.paramScale, s.scale)
          : d.append(o.paramScale, s.scale),
          d.has(o.paramX) ? d.set(o.paramX, s.x) : d.append(o.paramX, s.x),
          d.has(o.paramY) ? d.set(o.paramY, s.y) : d.append(o.paramY, s.y),
          d.has(o.paramExp)
            ? d.set(o.paramExp, s.exp.join("*"))
            : d.append(o.paramExp, s.exp.join("*")),
          d.has(o.paramMin)
            ? d.set(o.paramMin, s.min.join("*"))
            : d.append(o.paramMin, s.min.join("*")),
          d.has(o.paramAdjustify)
            ? d.set(o.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y)
            : d.append(o.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y),
      ...
      l.writeToIndexedDB &&
        ...
        l.writeToLocalStorage &&
          FamilyTree.localStorage.setItem(l.name, JSON.stringify(s));
    }
  }),
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    FamilyTree.events.publish("node-tree-menu-show", [this, T]),
      T.nodes.push(T.node),
      (this.config.nodes = T.nodes),
      (c = this.get(e));
    var v = this;
      ...
      (i.innerHTML = `<div>${r}</div>`),
        i.addEventListener("click", function (e) {
          if (
            ...
            for (
              var i = e.target.getAttribute("data-filter-field"),
                r = t.instance.element.querySelectorAll("[data-filter-menu]"),
                a = 0;
              a < r.length;
              a++
            )
              r[a].style.display = "none";
            var n = t.instance.element.querySelectorAll(
            ...
            var o = t.instance.element.querySelector(
              `[data-filter-menu="${i}"]`
            );
            if (!o) {
